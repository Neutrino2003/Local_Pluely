...
pub fn run() {
    ...
    let builder = builder
        .invoke_handler(tauri::generate_handler![
            ...
            whisper_models::download_whisper_model,
            local_whisper::transcribe_local_whisper,
            remote_control::remote_control_start,
            remote_control::remote_control_stop,
            remote_control::remote_control_status,
            remote_control::remote_control_regenerate_token,
            remote_control::remote_control_sync_overlay_state,
            remote_control::remote_control_push_chat_io,
            remote_control::remote_control_push_chat_sessions,
            remote_control::remote_control_push_chat_messages,
        ])
        .setup(|app| {
