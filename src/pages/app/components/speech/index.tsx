...
export const SystemAudio = (props: useSystemAudioType) => {
  ...
  return (
    <>
      <Button
        size="icon"
        title={`${getButtonTitle()} (Right-click for settings)`}
              ...
              <ScrollArea className="flex-1 min-h-0" ref={scrollAreaRef}>
                <div className="p-2 space-y-2">
                  ...
                  {setupRequired ? (
                    ...
                    <>
                      {/* Recording Panel */}
                      {/* Recording Panel (Background Status) */}
                      <RecordingPanel
                        isVadMode={isVadMode}
                      ...
                      <SettingsPanel
                        ...
                        includeMicInSystemAudio={includeMicInSystemAudio}
                        setIncludeMicInSystemAudio={setIncludeMicInSystemAudio}
                      />
