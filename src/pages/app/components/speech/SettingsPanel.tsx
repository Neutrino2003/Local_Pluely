      ...
      {isOpen && (
        <div className="px-3 pb-3 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between gap-4 rounded-md border border-border/50 p-2.5 bg-background/60">
              <div className="flex-1">
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">
                  {includeMicInSystemAudio
                    ? "Your mic and meeting audio are processed as separate speaker sources."
                    : "Only meeting/system audio is processed."}
                </p>
              </div>
              <Switch
