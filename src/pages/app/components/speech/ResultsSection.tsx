...
export const ResultsSection = ({
  ...
  const speakerPrefix = lastSpeakerLabel ? `${lastSpeakerLabel}: ` : "";
  const transcriptionContent =
    speakerPrefix && lastTranscription.startsWith(speakerPrefix)
      ? lastTranscription.slice(speakerPrefix.length)
      : lastTranscription;
        ...
        <div className="space-y-2">
          ...
          {lastTranscription && (
            <div className="rounded-md border-l-2 border-primary/50 bg-primary/5 p-2.5">
              ...
              <p className="text-sm">{transcriptionContent}</p>
            </div>
          )}
