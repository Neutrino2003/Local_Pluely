...
export function useHistory(): UseHistoryReturn {
  ...
  // NOTE: Remote control event listeners (remote-control-get-chat-sessions,
  // remote-control-get-chat-messages) are handled in app.context.tsx which is
  // always mounted. Do NOT duplicate them here to avoid double event handling.
